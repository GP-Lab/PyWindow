...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(5, _translate("MainWindow", "kaiser"))
        self.comboBox.setItemText(6, _translate("MainWindow", "flattop"))
        self.comboBox.setItemText(7, _translate("MainWindow", "lanczos"))
        self.comboBox.setItemText(8, _translate("MainWindow", "boxcar"))
        self.comboBox.setItemText(9, _translate("MainWindow", "parzen"))
        self.comboBox.setItemText(10, _translate("MainWindow", "bohman"))
        self.comboBox.setItemText(11, _translate("MainWindow", "blackmanharris"))
        self.comboBox.setItemText(12, _translate("MainWindow", "nuttall"))
        self.comboBox.setItemText(13, _translate("MainWindow", "barthann"))
        self.comboBox.setItemText(14, _translate("MainWindow", "cosine"))
        self.comboBox.setItemText(15, _translate("MainWindow", "exponential"))
        self.comboBox.setItemText(16, _translate("MainWindow", "tukey"))
        self.comboBox.setItemText(17, _translate("MainWindow", "taylor"))
        self.comboBox.setItemText(18, _translate("MainWindow", "chebwin"))
        self.comboBox.setItemText(19, _translate("MainWindow", "taylor"))
        self.comboBox.setItemText(20, _translate("MainWindow", "tukey"))
        self.comboBox.setItemText(21, _translate("MainWindow", "user defined"))
        ...
        self.actionHelp.setText(_translate("MainWindow", "Help Docs"))
